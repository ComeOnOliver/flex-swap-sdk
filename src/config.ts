...
const BARDOCK_TESTNET_CONFIG: SDKConfig = {
  ...
  INTERNAL_RESERVE_INDEXER: 'https://bardock-testnet.api.flextech.xyz/api/TokenPairPrices',
};
...
const MAINNET_CONFIG: SDKConfig = {
  ...
  INTERNAL_RESERVE_INDEXER: 'https://movement.api.flextech.xyz/api/TokenPairPrices',
};

export const CONFIG: Record<MOVEMENT_NETWORK, SDKConfig> = {
